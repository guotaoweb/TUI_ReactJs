        ...
        return (
            <Content2 tabs={tabs} key="content2_userEdit" goBackHref={this.goBack.bind(this)}>
                <div>
                    ...
                    <div style={{display:"none"}}><FormControls label="内部编码" ctrl="input" value="userMaintainInfo.staffCode"/></div>
                    <FormControls label="默认组织" ctrl="select" options={defaultUnit} value="userMaintainInfo.ext5" />
                    <div style={{display:"none"}}><FormControls label="员工类型" ctrl="select" options={kind} value="userMaintainInfo.kind" /></div>
                    ...
                    <div style={{display:"none"}}><FormControls label="短号码" ctrl="input" value="userMaintainInfo.shortNumber" /></div>
